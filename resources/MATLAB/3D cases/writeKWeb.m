...
for i = 1:num   
    ...
    for j = 1:length(Upgd{i,5})
        if j ~= length(Upgd{i,5})
            fprintf(fileID,'%f,',Upgd{i,5}(1,j));
        else
            fprintf(fileID,'%f',Upgd{i,5}(1,j));
        end
    end
...
for i = 1:num   
    ...
    for j = 1:length(Upgd{i,6})
        if j ~= length(Upgd{i,6})
            fprintf(fileID,'%f,',Upgd{i,6}(1,j));
        else
            fprintf(fileID,'%f',Upgd{i,6}(1,j));
        end
    end
...
for i = 1:num   
    ...
    for j = 1:length(Upgd{i,7})
        if j ~= length(Upgd{i,7})
            fprintf(fileID,'%f,',Upgd{i,7}(1,j));
        else
            fprintf(fileID,'%f',Upgd{i,7}(1,j));
        end
    end
